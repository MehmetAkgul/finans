                        ...
                        <div class="card">
                            ...
                            <div class="card-body ">
                                ...
                                <form action="{{route('fatura.update',['id'=>$data->id])}}" method="POST" enctype='multipart/form-data'>
                                    ...
                                    <button type="button" class="btn btn-primary btn-block" id="addRowBtn">YENİ GİDER KALEMİ EKLE</button>
                                    ...
                                    <div class="form-group float-right">
                                        <button class="btn btn-success" type="submit"> GİDER FATURASI GÜNCELLE</button>
                                    </div>
                                </form>
